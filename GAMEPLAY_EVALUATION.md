...
| report `power-provider` | Replayable ordinary-build crank-vs-treadle charging comparison over the same flywheel job. The actor shapes every component from raw through canonical manual craft (knapping the ordinary woodworking adze first, since boards have no honest equipment-free route), assembles provider plus store, then charges to full capacity under survival pressure. The episode reports build mass/attention, charge attention, bodily cost, and wear for both providers across the 500 J stone and 1,000 J paired ordinary stores, with matter conservation and trusted-load validity. The copper-reinforced crank stays catalog context: it needs mined native copper and cannot join this copper-free comparison. |

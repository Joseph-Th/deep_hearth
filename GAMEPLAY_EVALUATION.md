...
to the decision state. Fieldwork feedback aggregates pristine-estimate error across the whole sample and prefers
an estimate-disagreement example when present, rather than hiding long-order wear behind the first short order. Physical-duration summaries use the

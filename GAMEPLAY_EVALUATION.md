...
are unequal, so earlier goal completion is not a claim of universal economic dominance. The finite stockpile
order remains an explicit throughput exercise, not a recommendation to postpone useful upgrades.

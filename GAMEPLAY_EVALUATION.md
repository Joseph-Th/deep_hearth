...
`python ci.py report` is the bounded exploration surface. Its default concise view keeps the player
fantasy, one measured summary per ordinary probe, ordinary integration frontiers exposed by those probes,

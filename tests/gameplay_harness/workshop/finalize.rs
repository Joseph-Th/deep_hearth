...
pub(super) fn finalize_scenario(
    ...
    println!(
        "  outcome: ore={}/{}mg operations={} adaptive=[total:{} condition:{} stored-work:{}] before_event={} choices=[policy:{} single-source:{} manual-recharges:{}] suspended={} stranded_wip={} equipment=[crusher:{}ppm/{:?} crank:{}ppm] maintenance=[services:{} warning-deferred:{} critical-required:{} spent:{}mg remaining:{}mg] mechanical_reserve=[small:{}nJ high-power:{}nJ] manual_generation=[energy:{}nJ ticks:{} body:{}nJ/{}uL] survival=[spent-energy:{}nJ spent-hydration:{}uL vitality:{}ppm] active_support={:?}/cracked:{} ticks={}",

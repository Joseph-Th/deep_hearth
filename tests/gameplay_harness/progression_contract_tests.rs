...
use deep_hearth::content::{
    ...
    EQUIPMENT_COPPER_REINFORCED_STONE_CRUSHER, EQUIPMENT_COPPER_REINFORCED_STONE_QUARRY_PICK,
    EQUIPMENT_COPPER_REINFORCED_STONE_SEPARATOR, FORM_CHIP, FORM_REINFORCEMENT, FORM_SCRAP,
    FORM_TOOL, MATERIAL_COPPER, MATERIAL_STONE, PROCESS_COLD_WORK_COPPER_REINFORCEMENT,

...
impl FoundryReport {
    ...
    fn print_verbose(self) {
        reviewln!(
            ...
            self.thermal_after_cooldown.nanojoules(),
            self.cooldown_ticks,

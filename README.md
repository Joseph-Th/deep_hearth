...
| Durable runtime owners | `src/energy/`, `src/equipment/`, `src/fluid/`, `src/geology/`, `src/inventory/`, `src/labor/`, `src/logistics/`, `src/mining/`, `src/production/`, `src/structural/`, `src/survival/` | Owns one or more fields under `AppState::SystemState`; consequential durable mutation terminates in these owners. |

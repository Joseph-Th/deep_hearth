...
class LocalCiPlanTests(unittest.TestCase):
    ...
    def test_default_gameplay_report_keeps_compact_semantic_summaries_only(self) -> None:
        ...
        self.assertIn(
            "first-foundry=[defer:1/1 native:40..40t/100..100% setup:800..800t upgrade:1/1 recovery:50..50t/90..90%->80..80t/100..100% gain:2..2g/+30..+30t]",
            concise,
        )
        self.assertIn(

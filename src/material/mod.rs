...
/// the former size envelope: it records bounds without pretending to know how mass is distributed
/// inside them.
...
mod tests {
    ...
    #[test]
    fn particle_size_distribution_canonicalizes_order_and_preserves_weighted_classes() {
    ...
    #[test]
    fn particle_size_distribution_rejects_ambiguous_boundaries_and_noncanonical_save_order() {

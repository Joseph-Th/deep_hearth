...
use super::{
    ...
    OBJECT_COPPER_PLATE_SIZING_SCREEN, OBJECT_COPPER_REINFORCED_GEOLOGICAL_HAMMER,
    OBJECT_COPPER_REINFORCED_HAND_CRANK, OBJECT_COPPER_REINFORCED_PICK,
    OBJECT_COPPER_REINFORCED_STONE_CRUSHER, OBJECT_COPPER_REINFORCED_STONE_QUARRY_PICK,
    OBJECT_COPPER_REINFORCED_STONE_ROTARY_QUERN, OBJECT_COPPER_REINFORCED_STONE_SEPARATOR,
    OBJECT_COPPER_REINFORCED_WOODWORKING_ADZE, OBJECT_COPPER_REINFORCEMENT,
    OBJECT_COPPER_SAW_BLADE, OBJECT_COPPER_SCRAP, OBJECT_COPPER_SCREEN_PLATE, OBJECT_CRUSHED_ORE,
    OBJECT_DOUBLE_WALL_TIMBER_CHEST_BODY, OBJECT_DRY_SCREEN, OBJECT_ELECTRIC_FURNACE,
    OBJECT_GRAVITY_SEPARATOR, OBJECT_GRINDING_MILL, OBJECT_INSULATED_TIMBER_PANTRY_BODY,
    OBJECT_JAW_CRUSHER, OBJECT_LOG, OBJECT_MOLTEN_COPPER, OBJECT_NATIVE_COPPER,
    OBJECT_ROUGH_TIMBER_FIELD_BOX_BODY, OBJECT_STONE_CHIP, OBJECT_STONE_COBBING_HAMMER,
    OBJECT_STONE_CRUSHER, OBJECT_STONE_DRILL_BIT, OBJECT_STONE_FLYWHEEL,
    OBJECT_STONE_FLYWHEEL_PUMP_DRILL, OBJECT_STONE_GEOLOGICAL_HAMMER, OBJECT_STONE_HAND_CRANK,
    ...
    OBJECT_TIMBER_DRESSING_BENCH, OBJECT_TIMBER_FLYWHEEL, OBJECT_TIMBER_FRAME_COMMINUTION_MILL,
    OBJECT_TIMBER_FRAME_SAW_BENCH, OBJECT_TIMBER_HELVE_HAMMER, OBJECT_TIMBER_ORE_DRESSING_TABLE,
    OBJECT_TIMBER_RIDDLE_PANEL, OBJECT_TIMBER_RIDDLE_SIZING_SCREEN, OBJECT_TIMBER_SASH_SAWMILL,
    OBJECT_TIMBER_SPINDLE_DRILL, OBJECT_TIMBER_TREADLE_DRIVE, OBJECT_TIMBER_TREADLE_HAMMER,
    OBJECT_TIMBER_WALKING_WHEEL_DRIVE, OBJECT_WOOD_BOARD, OBJECT_WOOD_CHIP, OBJECT_WOOD_HANDLE,

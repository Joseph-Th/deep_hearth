...
pub use textures::{
    ...
    OBJECT_NATIVE_COPPER, OBJECT_ROUGH_TIMBER_FIELD_BOX_BODY, OBJECT_STONE_ARC_CRUCIBLE_FURNACE,
    OBJECT_STONE_CHIP, OBJECT_STONE_COBBING_HAMMER, OBJECT_STONE_CRUSHER, OBJECT_STONE_DRILL_BIT,
    OBJECT_STONE_FLYWHEEL, OBJECT_STONE_FLYWHEEL_PUMP_DRILL, OBJECT_STONE_GEOLOGICAL_HAMMER,
    OBJECT_STONE_GRINDSTONE_WHEEL, OBJECT_STONE_HAND_CRANK, OBJECT_STONE_INGOT_MOLD,
    ...
    OBJECT_TIMBER_DRESSING_BENCH, OBJECT_TIMBER_FLYWHEEL, OBJECT_TIMBER_FLYWHEEL_GRINDING_BENCH,
    ...
    OBJECT_TIMBER_TREADLE_DYNAMO, OBJECT_TIMBER_TREADLE_GRINDSTONE, OBJECT_TIMBER_TREADLE_HAMMER,
...
const REGISTRY_SCHEMA_VERSION: RegistrySchemaVersion = RegistrySchemaVersion::new(115);

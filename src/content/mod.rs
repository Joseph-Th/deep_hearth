...
pub use materials::{
    ...
    FORM_DOUBLE_WALL_CHEST_BODY, FORM_EXHAUSTED_TAILINGS, FORM_FLYWHEEL, FORM_FOOD, FORM_HANDLE,
    FORM_INGOT, FORM_INSULATED_PANTRY_BODY, FORM_LOG, FORM_LUMP, FORM_MOLTEN, FORM_NATIVE_METAL,
    FORM_ORE, FORM_REINFORCEMENT, FORM_ROUGH_BOX_BODY, FORM_SAW_BLADE, FORM_SCRAP,
    FORM_SCREEN_PLATE, FORM_STONE_CROCK_BODY, FORM_TAILINGS, FORM_TIMBER_RIDDLE_PANEL, FORM_TOOL,
    MATERIAL_BERRIES, MATERIAL_CLAY, MATERIAL_COPPER, MATERIAL_GRAIN, MATERIAL_LEGUMES,
...
const REGISTRY_SCHEMA_VERSION: RegistrySchemaVersion = RegistrySchemaVersion::new(106);

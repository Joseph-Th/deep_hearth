...
pub use textures::{
    ...
    OBJECT_STONE_SEPARATOR, OBJECT_STONE_TOOL, OBJECT_TAILINGS, OBJECT_WOOD_CHIP,
    OBJECT_WOOD_HANDLE, TEXTURE_CHARCOAL, TEXTURE_COPPER_HAMMERED, TEXTURE_COPPER_ORE,
...
const REGISTRY_SCHEMA_VERSION: RegistrySchemaVersion = RegistrySchemaVersion::new(60);

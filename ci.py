...
def ordinary_gameplay_diversity(lines: list[str]) -> list[str]:
    ...
    if survival:
        ...
        summaries.append(
            ...
            f"preservation=[attention-efficient:{count('storage-policy:attention-efficient')} physically-forced:{count('storage-policy:physically-forced')} balanced-frontier:{count('storage-policy:balanced-frontier')} maximum-protection:{count('storage-policy:maximum-protection')}] "
...
def player_takeaways(lines: list[str]) -> list[str]:
    ...
    if survival:
        ...
        takeaways.append(
            ...
            f"preservation=[efficient:{count('storage-policy:attention-efficient')} forced:{count('storage-policy:physically-forced')} "

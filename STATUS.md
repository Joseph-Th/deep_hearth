...
| Primitive progression | Stone tool shaping/assembly, hand mining, competing native-copper reinforcement of either extraction or stored-work rate, material-backed flywheel storage, hand-crank charging, and a player-built primitive crusher that can work while player labor is used elsewhere. Crushed ore currently provides direct attention/delegation value but has no downstream ordinary-play acquisition use until concentration/smelting capability becomes reachable. |

...
| Primitive progression | Stone tool shaping/assembly, hand mining, native-copper reinforcement, material-backed flywheel storage, hand-crank charging, and a player-built primitive crusher that can work while player labor is used elsewhere. |
